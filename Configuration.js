function getConfiguration(config)
{
  ...
  // address, you may want to use the code below.
   ...
   config.addressLabel = {en: "BH-EK9160", es: "BH-EK9160"};
}
...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperature sensor, while the second one is a carbon dioxide sensor.
    ...
    endpoints.addEndpoint("1", "Pressure", endpointType.pressureSensor);
    endpoints.addEndpoint("2", "Flow", endpointType.flowSensor);
    endpoints.addEndpoint("3", "Battery", endpointType.appliance);
    endpoints.addEndpoint("4", "Door", endpointType.appliance);
