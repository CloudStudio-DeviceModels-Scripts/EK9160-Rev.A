...
# Parsing + Configuration Script – EK9160 - Rev. A

This **Parsing + Configuration** script is designed for the **EK9160** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EK9160 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **EK9160** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
